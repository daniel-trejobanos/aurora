...
c
      ...
      rh = amin1(1.,ev/es)
c
c-----Hydrolysis of organic nitrate
c
...
c
c-----Heterogeneous rxn of N2O5 / SO2
c
      khet1 = 0.0
      khet2 = 0.0
      khet5 = 0.0
...
c
     ...
     &                    4. / ( cbarN2O5 * gamma_N2O5 ) )  ! [1/s]
        ...
        khet2 = y_clno2 * khet0
!bk        khet5 = saden * 1.e-6 / ( diam * 0.5e-6 / dc_SO2 +
!bk     &                            4. / ( cbarSO2 * gamma_SO2 ) ) ! [1/s]
c
c======================== DDM Begin =======================
c
        if ( lddm ) then !bk - broken
...
!bk          khet5 = khet5 + saden * 1.e-6 / ( diam * 0.5e-6 / dc_SO2 +
!bk     &                            4. / ( cbarSO2 * gamma_SO2 ) )
        enddo
