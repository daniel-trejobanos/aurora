      subroutine hr_nox2(y0,y1,yh,H2O,M,O2,CH4,H2,ny,rk,r,nr,dt)
      implicit none
c
c----CAMx v6.50 180430
c
c     HR_NOX2 solves the NOx family using Hertel's equations
c
...
c
     ...
     &       +          rk( 41)*yh(lNO2)*H2O
     &       +          rk( 83)*yh(lXO2N)
     &       + ( 0.100)*rk(151)*yh(lISO2)
     &       + ( 0.082)*rk(176)*yh(lBZO2)
     &       + ( 0.140)*rk(181)*yh(lTO2)
     &       + ( 0.140)*rk(186)*yh(lXLO2) )
c
...
c
     ...
     &       +          rk( 79)*yh(lXO2)
     &       +          rk(103)*yh(lHCO3)
     &       + ( 0.900)*rk(151)*yh(lISO2)
     &       +          rk(167)*yh(lEPX2)
     &       + ( 0.918)*rk(176)*yh(lBZO2)
     &       + ( 0.860)*rk(181)*yh(lTO2)
     &       + ( 0.860)*rk(186)*yh(lXLO2)
     &       +          rk(207)*yh(lOPO3) )
c
