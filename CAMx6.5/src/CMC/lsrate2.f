      subroutine lsrate2(neq,t,y,rate,nr,r)
      implicit none
c
c----CAMx v6.50 180430
c
c     LSRATE2 computes double precision species rates
c
...
c
      call lsrxn2(dH2O,dM,dO2,dCH4,dH2,y,dbrk,r)
c
      do l = 1,neq
        Loss(l) = 0.0d0
        Gain(l) = 0.0d0
