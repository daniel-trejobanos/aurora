      subroutine lsrate3(neq,t,y,rate,nr,r)
      implicit none
c
c----CAMx v6.50 180430
c
c     LSRATE3 computes double precision species rates
c
...
c
      call lsrxn3(dH2O,dM,dO2,dCH4,dH2,y,dbrk,r)
c
      do l = 1,neq
        Loss(l) = 0.0d0
        Gain(l) = 0.0d0
...
c  ETHA  ETOH   KET   PAR  ACET  PRPA   ROR  ETHY   ETH   OLE
c  IOLE  ISOP  ISO2  ISPD  INTR  ISPX  HPLD  OPO3  EPOX  EPX2
c  TERP  BENZ  CRES  BZO2  OPEN   TOL   TO2  XOPN   XYL  XLO2
c   CRO  CAT1  CRON  OPAN  ECH4   CL2    CL  HOCL   CLO  CLN3
c   HCL  FMCL  CLN2   BR2    BR  HOBR   HBR   BRO  BRN2  BRN3
c  FMBR    I2     I   HOI  INO3    HI    IO  INO2   OIO  I2O2
