...
c
      call fdate( cdate )
      write(iowrcp,9010,ERR=7000) 'CAMx', 
...
c
      write(iowrcp,9002,ERR=7000) 'Number of gas tracers groupings ',
     &                                                          nrtgas
c
...
c
      ...
      write(iowrcp,9003,ERR=7000) ' ',' ',' ',(ptname(i),i=1,nrtgas)
c
c   --- do the receptors ---
c
      write(iowrcp,9002,ERR=7000) 'Number of receptors ',nrcprt
      write(iowrcp,9007,ERR=7000) 'Receptor','Grid','I-cell',
     &                                          'J-cell','K-cell'
      do i=1,nrcprt
        write(iowrcp,9006,ERR=7000) i, idomrt(i), ircprt(i), 
     &                                     jrcprt(i), krcprt(i)
      enddo
c
