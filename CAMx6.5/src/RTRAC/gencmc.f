...
c
      ...
      call alloc_tracer_specs(ngrid,ncol,nrow,nlay,tectyp,mvecedge,iout)
...
c
     ...
     &                     ' WetDep(1/s)   spec# specname'
      do i = 1, ngasrtc
         ...
         enddo
         write(idiag,'(i4,1x,a10,3e12.3,i8,1x,a10)') 
     &         i,spnmrt(i),rtlbnd(i),dryrtc(i),wetrtc(i),
     &                                idprtc(i),ndprtc(i)
      enddo
      write(idiag,*)
c
