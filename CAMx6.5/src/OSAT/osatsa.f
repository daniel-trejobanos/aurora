...
c
      ...
      integer   i_N, iHN3, iTPN, iNTR, iOO, iVOC
      integer   idx_NIT, idx_HN3, idx_TPN, idx_NTR, idx_OO
      integer   istr1,istr2
...
c
         idx_NIT = idxcel + numcol * numrow * numlay * (i_N-1)
         ptconc(idx_NIT) =
...
c
         idx_HN3 = idxcel + numcol * numrow * numlay * (iHN3-1)
...
c
      ...
      do i=iptcls(idxipt(ITRO3N)),nptcls(idxipt(ITRO3V))
         iOO = iOO + 1
         idx = idxcel + numcol * numrow * numlay * (i-1)
         idx_OO = idxcel + numcol * numrow * numlay * (iOO-1)
