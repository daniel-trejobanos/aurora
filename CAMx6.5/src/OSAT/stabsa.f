...
c
      ...
      parameter( NSACB6  = 19 )
      parameter( NSASOAP = 4 ) ! Only for the tracers of multiple model species
...
c
      data spcsoap /'BENZ      ','TOL       ','XYL       ','IVOA      '/
c
      data rkohsoap / 1.80E3,     8.32E3,      2.73E4,      1.98E4 /
c
      data nonam  /'NO        '/
c
      data no2nam /'NO2       '/
