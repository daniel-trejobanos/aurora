c**** SPCCB6r4SA
c
      subroutine spccb6r4sa(namecls,numcls,coefcon,coeflux,
...
c-----------------------------------------------------------------------
c
c     06/24/16   --bkoo--       Created based on spccb6r2sa.f
...
c-----------------------------------------------------------------------
c
c   NUMCB6r4      I  number of CB6r4 species used by PSAT treatment
c
      integer NUMCB6r4
c
      parameter( NUMCB6r4 = 60 )
c
c-----------------------------------------------------------------------
c    Local variables:
c-----------------------------------------------------------------------
c
      character*10 cb6r4nam(NUMCB6r4)
      integer*4    i, j
      real         wtcb6r4(NUMCB6r4)
c
c-----------------------------------------------------------------------
c    Data statements:
c-----------------------------------------------------------------------
...
c
      do i=1,nspec
        molwt(i) = 1.0
        do j=1,NUMCB6r4
           if( spname(i) .EQ. cb6r4nam(j) ) molwt(i) = wtcb6r4(j)
        enddo
      enddo
c
