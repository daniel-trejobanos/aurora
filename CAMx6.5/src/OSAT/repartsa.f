...
c
      ...
      integer ipno3, ipnh4, ipo1, ipo2, ipo3, ipo4
      integer idxpo1, idxpo2, idxpo3, idxpo4
      integer idxcg1, idxcg2, idxcg3, idxcg4
      integer ippa, ippb, idxppa, idxppb, idxisp
...
c
     ...
     &                          - delcon(6,ksopa) ! due to SOA polymerization & photolysis
         ...
         do i=iptcls(idxipt(ITRPPA)),nptcls(idxipt(ITRPPA))
           idxppa = idxcel + numcol * numrow * numlay * (i-1)
     ...
     &                          - delcon(7,ksopb) ! and in-cloud SOA formation
         ...
         do i=iptcls(idxipt(ITRPPB)),nptcls(idxipt(ITRPPB))
           idxppb = idxcel + numcol * numrow * numlay * (i-1)
...
c
         ...
         do i=iptcls(idxipt(ITRISP)),nptcls(idxipt(ITRISP))
            idxisp = idxcel + numcol * numrow * numlay * (i-1)
