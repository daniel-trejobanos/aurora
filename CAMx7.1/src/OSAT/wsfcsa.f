c*** WSRFSA
c
      subroutine wsfcsa(ngrd, iendat, endtim, nox, noy, noz, nspsa, saavrg)
      use camxcom
      use tracer
      use filunit
c
...
c
       ...
       integer   noz
       integer   nspsa
       real      saavrg(nox,noy,noz,nspsa)
c
c-----------------------------------------------------------------------
c    Local variables:
c-----------------------------------------------------------------------
c
      integer       idate, jdate, ibegcel iendcel, jbegcel, jendcel
      integer       isegmt, i, j, l, nspcout, k
...
c
     ...
     &           (ispec(i,l),i=1,10),((saavrg(i,j,k,l),i=ibegcel,iendcel),j=jbegcel,jendcel)
            enddo
   40     continue
          if( ntrtim .GT. 0 ) then
