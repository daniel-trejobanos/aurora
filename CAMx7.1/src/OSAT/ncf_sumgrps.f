...
c
              allocate( emstmp(numcols-2*buffer_offset,numrows-2*buffer_offset,nlays_in) )
              allocate( emsgrd(numcols,numrows,nlays_in) )
c
...
c
     ...
     &              this_date,this_time*100.,this_time_tflag,this_time_etflag,
     &                                                         le1day,.TRUE.)
                     ...
                     do k=1,nlays_in
                        do j=1+buffer_offset,nrow(igrid)-buffer_offset
                            ...
                            do i=1+buffer_offset,ncol(igrid)-buffer_offset
                              ...
                              emsgrd(i,j,1) = emstmp(itmp,jtmp,k)
                           enddo
                        enddo
                     enddo
