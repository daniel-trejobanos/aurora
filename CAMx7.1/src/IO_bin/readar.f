...
c
        if( lvbs .AND. LVBSPREPROC ) then
           if( arspcname .EQ. 'POA_OP    ' ) then 
              ...
              do j=1+buffer_offset,nrow-buffer_offset
                 do i=1+buffer_offset,ncol-buffer_offset
                   poa_op_em(i,j) = poa_op_em(i,j) + argrid(i,j)
                 enddo
              enddo
              goto 50
           endif
           if( arspcname .EQ. 'POA_GV    ' ) then
              ...
              do j=1+buffer_offset,nrow-buffer_offset
                 do i=1+buffer_offset,ncol-buffer_offset
                   poa_gv_em(i,j) = poa_gv_em(i,j) + argrid(i,j)
                 enddo
              enddo
              goto 50
           endif
           if( arspcname .EQ. 'POA_DV    ' ) then
              ...
              do j=1+buffer_offset,nrow-buffer_offset
                 do i=1+buffer_offset,ncol-buffer_offset
                   poa_dv_em(i,j) = poa_dv_em(i,j) + argrid(i,j)
                 enddo
              enddo
              goto 50
           endif
           if( arspcname .EQ. 'POA_MC    ' ) then
              ...
              do j=1+buffer_offset,nrow-buffer_offset
                 do i=1+buffer_offset,ncol-buffer_offset
                   poa_mc_em(i,j) = poa_mc_em(i,j) + argrid(i,j)
                 enddo
              enddo
              goto 50
           endif
           if( arspcname .EQ. 'POA_BB    ' ) then
              ...
              do j=1+buffer_offset,nrow-buffer_offset
                 do i=1+buffer_offset,ncol-buffer_offset
                   poa_bb_em(i,j) = poa_bb_em(i,j) + argrid(i,j)
                 enddo
              enddo
              goto 50
           endif
