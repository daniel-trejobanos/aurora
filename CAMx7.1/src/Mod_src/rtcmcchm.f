...
c
         ...
         allocate( hlawschm(numtracs+numspec) )
         allocate( tfacschm(numtracs+numspec) )
         allocate( molwschm(numtracs+numspec) )
         allocate( reacschm(numtracs+numspec) )
         allocate( rsclschm(numtracs+numspec) )
