      subroutine cpamech4(r, rk, dtfact, nr, pa, npa, npa_init, ldark )
...
c----CAMx v7.10 210105
c
c     CPAMECH4 computes chemical process analysis (CPA) parameters
c
