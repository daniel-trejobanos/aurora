...
c
     ...
     &             'PFP2      ','PFP3      ','PFP4      ',
     &             'HGIIP     ','HGIIPC    ','HGP       ',
     &             'PSO4_1    ','PSO4_2    ','PSO4_3    ',
     &             'PSO4_4    ','PSO4_5    ','PSO4_6    ',
     &             'PSO4_7    ','PSO4_8    ','PSO4_9    ',
     &             'PSO4_10   ','PNO3_1    ','PNO3_2    ',
     &             'PNO3_3    ','PNO3_4    ','PNO3_5    ',
     &             'PNO3_6    ','PNO3_7    ','PNO3_8    ',
     &             'PNO3_9    ','PNO3_10   ','PNH4_1    ',
     ...
     &             'SOA4_9    ','SOA4_10   ','SOPA_1    ',
     &             'SOPA_2    ','SOPA_3    ','SOPA_4    ',
     &             'SOPA_5    ','SOPA_6    ','SOPA_7    ',
     &             'SOPA_8    ','SOPA_9    ','SOPA_10   ',
     &             'SOPB_1    ','SOPB_2    ','SOPB_3    ',
     &             'SOPB_4    ','SOPB_5    ','SOPB_6    ',
     &             'SOPB_7    ','SOPB_8    ','SOPB_9    ',
     &             'SOPB_10   ','PEC_1     ','PEC_2     ',
     &             'PEC_3     ','PEC_4     ','PEC_5     ',
     &             'PEC_6     ','PEC_7     ','PEC_8     ',
     &             'PEC_9     ','PEC_10    ','CRST_1    ',
...
c           mchaero is max among PM mech, VBS + 3 optional Hg specs
      data mchactv  /  1,  0,  1,  1,  1,  1,  0,  0,  0,  0 /
      data mchgas   /116,  0,122,116,126, 80,  0,  0,  0,999 /
      data mchaero  / 47,  0, 29, 47, 29, 47,  0,  0,  0,999 /
      data mchrad   / 25,  0, 27, 25, 45, 13,  0,  0,  0,  0 /
      data mchrxn   /234,  0,304,233,565,156,  0,  0,  0,  0 /
      data mchphot  / 34,  0, 53, 34, 41, 23,  0,  0,  0,  0 /
      ...
      data jhcho1s07,jhcho1cb5,jhcho1cb6    /204, 75, 97/
      data jhcho2s07,jhcho2cb5,jhcho2cb6    /205, 76, 98/
      data jch3chos07,jch3chocb5,jch3chocb6 /209, 87,108/
...
c
 ...
 110  continue
     ...
     &         ' This will use your customized CAMx/chem10.f subroutine'
        elseif ((idmech.eq.1 .OR. idmech.eq.3 .OR. idmech.eq.4) .AND. .NOT.lixemis) then
          write(iout,'(/,a)') ' WARNING in READCHM:'
          write(iout,'(a)')' You selected CB6r2h or CB6r4 or CB6r5,'
