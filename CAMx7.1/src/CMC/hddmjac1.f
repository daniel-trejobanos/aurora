      subroutine hddmjac1(njac,nrxn,H2O,M,O2,CH4,H2,flg,jac,y,rk)
      implicit none
c
c----CAMx v7.10 210105
c
c     HDDMJAC1 computes a full Jacobian for HDDM
c
...
c
     ...
     &                      +(-0.130)*rk( 57)    *y(lC2O3)
     &                      +(-0.130)*rk( 65)    *y(lCXO3)
     &                      +(-0.130)*rk(202)    *y(lOPO3)
          JAC(lO3  ,lC2O3)= +(-0.130)*rk( 57)    *y(lHO2)
          JAC(lO3  ,lCXO3)= +(-0.130)*rk( 65)    *y(lHO2)
          ...
          JAC(lO3  ,lOPO3)= +(-0.130)*rk(202)    *y(lHO2)
     ...
     &                      +(-0.933)*rk(155)    *y(lOH)
          ...
          JAC(lOH  ,lOPO3)= +(-0.500)*rk(202)    *y(lHO2)
     ...
     &                      +(-1.000)*rk(115)    *y(lNO3)
          ...
          JAC(lHO2 ,lETH )= +(-0.270)*rk(135)    *y(lO3)
     ...
     &                      +(-1.000)*rk(231)    *y(lDMS)
     &                      +(-1.000)*rk(232)    *y(lDMS)*O2
          JAC(lMEO2,lHO2 )= +(-0.500)*rk( 57)    *y(lC2O3)
     &                      +(-0.500)*rk( 65)    *y(lCXO3)
     &                      +         rk( 72)    *y(lMEO2)
     &                      +(-0.500)*rk(202)    *y(lOPO3)
     ...
     &                      +(-0.900)*rk( 73)    *y(lC2O3)
     &                      +         rk( 74)    *y(lRO2)
          JAC(lMEO2,lRO2 )= +(-1.000)*rk( 58)    *y(lC2O3)
     &                      +(-1.000)*rk( 66)    *y(lCXO3)
     &                      +         rk( 74)    *y(lMEO2)
     ...
     &                      +(-0.340)*rk(154)*flg
          JAC(lMEO2,lOPO3)= +(-0.500)*rk(202)    *y(lHO2)
     ...
     &                      +(-1.000)*rk(208)    *y(lECH4)
          JAC(lRO2 ,lHO2 )= +(-0.500)*rk( 57)    *y(lC2O3)
     &                      +(-0.500)*rk( 65)    *y(lCXO3)
     &                      +         rk( 69)    *y(lRO2)
     &                      +(-0.500)*rk(202)    *y(lOPO3)
     ...
     &                      +(-0.840)*rk(154)*flg
          ...
          JAC(lRO2 ,lOPO3)= +(-0.500)*rk(202)    *y(lHO2)
     ...
     &                      +         rk( 56)*flg
          ...
          JAC(lPACD,lHO2 )= +(-0.370)*rk( 57)    *y(lC2O3)
     &                      +(-0.370)*rk( 65)    *y(lCXO3)
     &                      +(-0.370)*rk(202)    *y(lOPO3)
          JAC(lPACD,lC2O3)= +(-0.370)*rk( 57)    *y(lHO2)
          JAC(lPACD,lPACD)= +         rk( 95)    *y(lOH)
          JAC(lPACD,lCXO3)= +(-0.370)*rk( 65)    *y(lHO2)
          JAC(lPACD,lOPO3)= +(-0.370)*rk(202)    *y(lHO2)
          JAC(lAACD,lO3  )= +(-0.130)*rk(138)    *y(lOLE)
     &                      +(-0.080)*rk(141)    *y(lIOLE)
          JAC(lAACD,lOH  )= +         rk( 94)    *y(lAACD)
          JAC(lAACD,lHO2 )= +(-0.130)*rk( 57)    *y(lC2O3)
     &                      +(-0.130)*rk( 65)    *y(lCXO3)
     &                      +(-0.130)*rk(202)    *y(lOPO3)
          JAC(lAACD,lC2O3)= +(-0.130)*rk( 57)    *y(lHO2)
     &                      +(-0.100)*rk( 73)    *y(lMEO2)
     &                      +(-0.200)*rk( 77)    *y(lXO2H)
     &                      +(-0.200)*rk( 81)    *y(lXO2)
     &                      +(-0.200)*rk( 85)    *y(lXO2N)
     ...
     &                      +(-0.200)*rk(161)    *y(lEPX2)
          ...
          JAC(lAACD,lCXO3)= +(-0.130)*rk( 65)    *y(lHO2)
          ...
          JAC(lAACD,lOPO3)= +(-0.130)*rk(202)    *y(lHO2)
     &                      +(-0.200)*rk(204)    *y(lRO2)
     ...
     &                      +(-2.000)*rk(190)    *y(lXOPN)
     &                      +(-0.400)*rk(194)    *y(lOPEN)
          JAC(lXO2H,lHO2 )= +         rk( 76)    *y(lXO2H)
          JAC(lXO2H,lC2O3)= +(-1.000)*rk( 60)    *y(lCXO3)
     &                      +         rk( 77)    *y(lXO2H)
     &                      +(-0.072)*rk(146)    *y(lISO2)
          JAC(lXO2H,lRO2 )= +         rk( 78)    *y(lXO2H)
     ...
     &                      +(-0.340)*rk(154)*flg
          JAC(lXO2H,lOPO3)= +(-0.800)*rk(204)    *y(lRO2)
     ...
     &                      +(-1.000)*rk(187)    *y(lNO3)
          ...
          JAC(lFACD,lO3  )= +(-0.420)*rk(135)    *y(lETH)
     &                      +(-0.090)*rk(138)    *y(lOLE)
     ...
     &                      +(-0.500)*rk(103)    *y(lHO2)
          ...
          JAC(lFACD,lETH )= +(-0.420)*rk(135)    *y(lO3)
     ...
     &                      +(-0.500)*rk(199)    *y(lOPO3)
          JAC(lCO  ,lO3  )= +(-0.350)*rk(135)    *y(lETH)
     &                      +(-0.378)*rk(138)    *y(lOLE)
     ...
     &                      +(-1.000)*rk(118)    *y(lOH)
          ...
          JAC(lCO  ,lETH )= +(-0.350)*rk(135)    *y(lO3)
     ...
     &                      +(-0.625)*rk(142)    *y(lNO3)
          ...
          JAC(lALDX,lOPO3)= +(-1.000)*rk(203)    *y(lC2O3)
     &                      +(-0.800)*rk(204)    *y(lRO2)
