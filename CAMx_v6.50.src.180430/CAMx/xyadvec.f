...
c
            flux1 = DBLE(flxarr(1)   *av1d(1)*dx(j+j0)*mapscl(2,j)**2.)
            flux2 = DBLE(flxarr(m1-1)*av1d(m1-1)*dx(j+j0)*mapscl(m1-1,j)**2.)
...
c
            flux1 = DBLE(flxarr(1)   *av1d(1)*dy*mapscl(i,2)**2.)
            flux2 = DBLE(flxarr(m2-1)*av1d(m2-1)*dy*mapscl(i,m2-1)**2.)
