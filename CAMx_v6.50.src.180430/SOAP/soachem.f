...
c
     ...
     &              8.80d-13, -180.2d0,    ! rxn 19  SQT-O2 + NO  (assumed same as TRP-O2 + NO)
     &              4.10d-13, -790.0d0,    ! rxn 20  SQT-O2 + HO2 (assumed same as TRP-O2 + HO2)
c
     &              1.34d-11,    0.0d0,    ! rxn 21  IVOC + OH (Hodzic et al., 2016, ACP)
     &              2.70d-12, -360.0d0,    ! rxn 22  IVOC-O2 + NO  (assumed same as ARO-O2 + NO)
     &              1.90d-13,-1300.0d0 /), ! rxn 23  IVOC-O2 + HO2 (assumed same as ARO-O2 + HO2)
     &           (/ 2, nrxn /) )
c
c======================== DDM Begin =======================
c
